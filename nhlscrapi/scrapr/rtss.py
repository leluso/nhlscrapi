...
from nhlscrapi.scrapr.teamnameparser import get_abbreviation


class RTSS(ReportLoader):
    """Retrieve and load RTSS play by play game data"""

    def __init__(self, game_key, game=None):
    ...
    def parse_plays_stream(self):
        ...
        if lx_doc is not None:
            ...
            for p in plays:
                p_obj = parser.build_play(p, game=self.game)
...
class PlayParser(object):
    ...
    def build_play(self, pbp_row, game=None):
        """
